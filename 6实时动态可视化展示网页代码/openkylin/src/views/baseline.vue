            ...
            <div class="left">
                <div style="font-size: 20px; font-weight: bold; display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <div style="padding: 10px; margin-bottom: 10px; background-color: rgba(63, 150, 165, 0.1);">
                      ...
                      <span style="font-size: 24px; color: #00FF00;">{{ hostname }}</span>  <!-- 更改主机名称值的颜色为紫色 -->
                    </div>
                    <div style="padding: 10px; margin-bottom: 10px; background-color: rgba(63, 150, 165, 0.1);">
                      <span style="font-size: 24px; color: #FF5733;">扫描类型：</span>
                      <span style="font-size: 24px; color: #00FF00;">{{ scanType }}</span>  <!-- 更改扫描类型值的颜色为橙色 -->
                    </div>
                    <div style="padding: 10px; background-color: rgba(63, 150, 165, 0.1); margin-top: -10px;">
                      ...
                      <span style="font-size: 24px; color: #00FF00;">{{ score }}</span>  <!-- 更改检测评分值的颜色为蓝色 -->
                    </div>
                    <a href="http://152.136.142.183:39010/baselinerepair" target="_blank" style="padding: 10px 20px; background-color: #4CAF50; color: white; border-radius: 5px; margin-top: -10px;">基线修复</a>  
                  </div>
              <dv-border-box-10>
